...
echo ""
echo -e "  ${GREEN}Epistole is deployed and configured.${NC}"
echo ""
echo -e "  ${BOLD}Worker URL:${NC}  $WORKER_URL"
echo -e "  ${BOLD}MCP endpoint:${NC} ${MCP_ENDPOINT}"
echo -e "  ${BOLD}Server files:${NC} $INSTALL_DIR"
echo ""
echo -e "  ${BOLD}Next steps:${NC}"
echo -e "  1. Restart Claude Desktop"
echo -e "  2. Ask Claude: ${DIM}\"Show my recent emails\"${NC}"
echo -e "  3. Ask Claude: ${DIM}\"Sync my email now\"${NC} (bootstraps search index)"
echo ""
echo -e "  ${DIM}Sync runs automatically every 15 minutes.${NC}"
echo -e "  ${DIM}Your credentials are encrypted as Cloudflare Worker secrets.${NC}"
echo -e "  ${DIM}Your MCP token: ${MCP_TOKEN}${NC}"
echo -e "  ${DIM}(Save this somewhere — you won't see it again)${NC}"
echo ""
