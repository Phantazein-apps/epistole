...
## WhatsApp bridge (deprecated)

The optional WhatsApp mirror has been deprecated and is no longer registered with the Worker. Source has been moved to [`deprecated/`](deprecated/) with a revival guide. The `semantic_search` tool now searches email only.
